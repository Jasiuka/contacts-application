<template>
  <page-layout page-special-class="page-special-actions--simple">
      ...
      <div class="page-special-actions">
        ...
        <div class="structure-tabs">
          <button
            ...
            :class="{
              'structure-tab--active': getActiveStructureTab === 'offices',
            }"
            class="structure-tab"
          >
            Ofisai
          ...
          <button
            ...
            :class="{
              'structure-tab--active': getActiveStructureTab === 'divisions',
            }"
            class="structure-tab"
          >
            Padaliniai
          ...
          <button
            ...
            :class="{
              'structure-tab--active': getActiveStructureTab === 'departments',
            }"
            class="structure-tab"
          >
            Skyriai
          ...
          <button
            ...
            :class="{
              'structure-tab--active': getActiveStructureTab === 'groups',
            }"
            class="structure-tab"
          >
            Grupės
    ...
    <template #content>
      <h2 v-if="!getStructures.length">Atsiprašome, tačiau duomenų nerasta.</h2>
      <structures-table
        v-else
...
export default {
  ...
  computed: {
    ...mapGetters(["getStructures", "getActiveStructureTab", "getPermissions"]),
    createTableHeadName() {
